							...
							<form method="POST" action="{{ route('Programas.store') }}" enctype="multipart/form-data">
									...
									<div class="col-xs-6 col-sm-6 col-md-6">
										<div class="form-group">
											<select class="form-control input-sm" id=PlataformaPrograma name="PlataformaPrograma">
												...
												<option value="x64">x86/x64</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
										<div class="form-group">
											<input type="file" class="form-control input-sm" name="ArchivoSubir" id="ArchivoSubir" placeholder="Subir archivo">
										</div>
									</div>
								</div>
								<div class="row" >
									<div class="col-xs-12 col-sm-12 col-md-12">
										<div class="form-group">
											<input type="text" class="form-control input-sm" name="LinkDescargaPrograma" id="LinkDescargaPrograma" placeholder="Subir archivo"  value="archivo">
										</div>
									</div>
								</div>
								<div class="row">
