...
@section('content')@extends('layouts.layout')
@section('content')
<div class="row">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">					
					<div class="table-container">
						<form method="POST" action="{{ route('Programas.edit',$Programas->id) }}"  role="form">
							{{ csrf_field() }}
							<input name="_method" type="hidden" value="PATCH">
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="NombrePrograma" id="NombrePrograma" class="form-control input-sm" value="{{$Programas->NombrePrograma}}">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="PlataformaPrograma" id="PlataformaPrograma" class="form-control input-sm" value="{{$Programas->PlataformaPrograma}}">
									</div>
								</div>
							</div>>
							<div class="row">
								<div class="col-xs-4 col-sm-4 col-md-4">
									<div class="form-group">
										<input type="text" name="VersionPrograma" id="VersionPrograma" class="form-control input-sm" value="{{$Programas->VersionPrograma}}">
									</div>
								</div>
								<div class="col-xs-4 col-sm-4 col-md-4">
									<div class="form-group">
										<input type="text" name="UsuarioPrograma" id="UsuarioPrograma" class="form-control input-sm" value="{{$Programas->UsuarioPrograma}}">
									</div>
								</div>
								<div class="col-xs-4 col-sm-4 col-md-4">
									<div class="form-group">
										<input type="text" name="ClavePrograma" id="ClavePrograma" class="form-control input-sm" value="{{$Programas->ClavePrograma}}">
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<select class="form-control input-sm" id=PlataformaPrograma name="PlataformaPrograma">
											<option value="null" disabled>Selecctione una opcion</option>
